        ...
        <h5 class="font-size-20">
            Carrinho <span>
                ...
                if ($_SESSION['logged'] == true) {
                    echo $acc->getAccount($_COOKIE['user_id'], 'user')['fullname'];
                } else {
                    echo 'Guest';
                }
                ?>)
                            ...
                            <div class="qty d-flex pt-2">
                                ...
                                <form method="POST">
                                    ...
                                    <button type="submit" name="delete-cart-submit"
                                        class="btn text-danger px-3 border-right">Retirar</button>
                                </form>
                            </div>
                            <!-- !product qty -->
                        </div>
            ...
            <div class="col-sm-3">
                <div class="sub-total border text-center mt-2">
                    <h6 class="font-size-12  text-success py-3">
                        ...
                        Frete gratuito para seu pedido.
                    </h6>
                    <div class="border-top py-4">
                        ...
                        <button type="submit" class="btn btn-warning mt-3" onclick="alert('Em desenvolvimento')">Finalizar Compra</button>
                    </div>
                </div>
            </div>
